...
namespace Peg.Collections
{
    ...
    public static class CollectionExtensions
    {
        ...
        */
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public static int IndexOfRandomWithState<T>(this List<T> list, Func<T, bool> predicate)
        {
            int len = list.Count;
            int left = len;
            for (int i = 0; i < len; i++)
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public static bool IndicesOfRandomWithState<T>(this List<T> list, int needed, Func<T, bool> predicate, ref List<int> outList)
        {
            int len = list.Count;
            int left = len;
            Assert.IsTrue(needed > 0);
